...
class AudioProcessor:
    ...
    def __init__(
        ...
        if engine == "coqui":
            ...
            voice_path = self.reference_audio or self.requested_voice or "reference_audio.wav"
            ...
            self.engine = KokoroEngine(
                voice=self.requested_voice or "af_heart",
                default_speed=1.26,
                trim_silence=True,
            ...
            voice_name = self.requested_voice or "tara"
            voice_obj = OrpheusVoice(voice_name)
            self.engine.set_voice(voice_obj)
        else:
